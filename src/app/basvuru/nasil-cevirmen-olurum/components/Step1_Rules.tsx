      ...
      <div className="mt-8 space-y-4 text-left">
        ...
        <div className="p-6 rounded-lg bg-white/50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 backdrop-blur-sm">
          ...
          <ol className="space-y-3 columns-1 md:columns-2">
            {rulesList.map((rule, index) => (<li key={index} className="flex items-start text-sm"><Check className="h-4 w-4 mr-2 mt-0.5 text-blue-500 shrink-0" /> <span className="flex-1 text-neutral-600 dark:text-neutral-400">{rule}</span> </li>))}
          </ol>
        </div>
      </div>
